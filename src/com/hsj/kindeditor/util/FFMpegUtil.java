...
import com.hsj.kindeditor.ffmpeg.CmdExecuter;
import com.hsj.kindeditor.ffmpeg.IStringGetter;
...
public class FFMpegUtil implements IStringGetter{
	...
	public void videoTransfer( 
		...
		System.out.println(originFileUri);
	...
	public static void main(String[] args) {
		FFMpegUtil m = new FFMpegUtil("C:\\Users\\Administrator\\Desktop\\kindeditor+ffmpeg+jquery-uploadify\\WebRoot\\WEB-INF\\ffmpeg\\bin\\ffmpeg.exe", "C:\\Users\\Administrator\\Desktop\\test\\b.flv");
		m.videoTransfer("C:\\Users\\Administrator\\Desktop\\test\\ddd.mp4", "160x120", 20, 20, 100, 15);//转换视频
		m.makeScreenCut("d:\\a.png", "640x480"); //获取截图
	}
}
